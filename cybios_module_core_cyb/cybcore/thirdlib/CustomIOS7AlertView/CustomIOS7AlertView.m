...
- (void)show
{
    ...
    containerView.layer.cornerRadius = kCustomIOS7AlertViewCornerRadius;
}
...
- (UIView *)createContainerView
{
    ...
    lineView.backgroundColor = [UIColor colorWithRed:230.0/255.0 green:230.0/255.0 blue:230.0/255.0 alpha:1.0f];
